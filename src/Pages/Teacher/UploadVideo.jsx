...
const UploadVideo = () => {
  ...
  return (
    <div>
        <ComponentHeader title="Upload Video"/>
        <Container>
            <form onSubmit={getData}>
                <Grid container spacing={2} sx={{my: '0.5rem'}}>
                    ...
                    <Grid item xs={12} md={6}>
                        <TextField
                            fullWidth
                            label="Enter Course Chapter"
                            id="outlined-courseChapter"
                            sx={{backgroundColor: '#fff'}}
                            value={values.courseChapter}
                            onChange={handleChange('courseChapter')}
                        />
                    </Grid>  
                    <Grid item xs={12} md={6}>
                        <TextField
